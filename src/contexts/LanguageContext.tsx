...
const translations: Record<Language, TranslationTree> = {
  en: {
    ...
    menu: {
      ...
      customizer: {
        ...
        noExtraAllowed: "No extra allowed",
        decreaseExtraQuantity: "Decrease extra quantity",
        increaseExtraQuantity: "Increase extra quantity",
        options: "Options",
        selectOne: "Select 1",
        selectUpTo: "Select up to {max}",
        completed: "Completed",
        required: "Required",
        groupRequired: "{name} is required",
        selectAtLeast: "{name}: select at least {min}",
        selectAtMost: "{name}: select at most {max}",
        onlyOneAllowed: "{name}: only 1 allowed",
        optionMax: "{name}: max {max}",
        makeItAMeal: "Make it a meal",
        chooseItem: "Choose item",
        requiredShort: "Required",
        optional: "Optional",
        selectComboItem: "Select a combo item",
        tooManyComboItems: "Too many combo items selected",
        specialInstructions: "Special instructions",
        notePlaceholder: "Add a note for the kitchen (e.g. no onions, extra sauce)…",
        subtotal: "Subtotal",
        jumpToIt: "Jump to it",
        addToOrder: "Add to order",
      },
    ...
    orderWorkflow: {
      ...
      saveChanges: "Save changes",
      saveSuccess: "Order workflow rules saved",
      saveError: "Failed to save order workflow rules",
      loadError: "Failed to load order rules",
      saved: "Saved",
      tryAgain: "Try again",
      moveUp: "Move up",
      moveDown: "Move down",
      allowTransition: "Allow transition from {from} to {to}",
    ...
    status: {
      ...
      pricingUnavailable: "Pricing is temporarily unavailable. Please try again 🔄",
      tryAgain: "Try again",
    ...
    team: {
      ...
      loadError: "Couldn't load the team. Please try again.",
      empty: "No team members yet",
      emptyDescription: "Add your first team member to share access to this organization.",
      email: "Email",
      name: "Name",
      password: "Password",
      passwordHint: "Only needed if this person doesn't have an account yet (min. 8 characters).",
      role: "Role",
      status: "Status",
      joined: "Joined",
      roleOwner: "Owner",
      ...
      addError: "Couldn't add this member. Please try again.",
      changeRole: "Change role for {name}",
      changeStatus: "Change status for {name}",
      updateError: "Couldn't update this member. Please try again.",
  ...
  ar: {
    ...
    auth: {
      ...
      restaurantNamePlaceholder: "بيلا فيستا",
    ...
    menu: {
      ...
      all: "الكل",
      addToCart: "عالسلّة ✨",
      viewDetailsFor: "شوف تفاصيل {name}",
      ...
      customizer: {
        loading: "عم نحمّل تفاصيل الصنف…",
        errorLoadingItem: "ما قدرنا نحمّل الصنف",
        itemNotFound: "الصنف مش موجود.",
        close: "سكّر",
        ...
        no: "بدون",
        extra: "إضافي",
        notRemovable: "ما بنقدر نشيله",
        noExtraAllowed: "الإضافة غير متاحة",
        decreaseExtraQuantity: "نقّص كمية الإضافات",
        increaseExtraQuantity: "زيد كمية الإضافات",
        options: "الخيارات",
        selectOne: "اختار ١",
        selectUpTo: "اختار لحد {max}",
        completed: "مكتمل",
        required: "مطلوب",
        groupRequired: "{name} مطلوب",
        selectAtLeast: "{name}: اختار على الأقل {min}",
        selectAtMost: "{name}: اختار بحد أقصى {max}",
        onlyOneAllowed: "{name}: مسموح بخيار واحد فقط",
        optionMax: "{name}: الحد الأقصى {max}",
        makeItAMeal: "خلّيه وجبة",
        chooseItem: "اختار صنف",
        requiredShort: "مطلوب",
        optional: "اختياري",
        selectComboItem: "اختار صنف من الوجبة",
        tooManyComboItems: "اخترت أصناف زيادة",
        specialInstructions: "ملاحظات خاصة",
        notePlaceholder: "أضف ملاحظة للمطبخ (مثال: بدون بصل، صوص زيادة)…",
    ...
    orderWorkflow: {
      ...
      saveChanges: "حفظ التغييرات",
      saveSuccess: "تم حفظ قواعد سير الطلب",
      saveError: "ما قدرنا نحفظ قواعد سير الطلب",
      loadError: "ما قدرنا نحمّل قواعد الطلب",
      saved: "تم الحفظ",
      tryAgain: "جرّب مرّة ثانية",
      moveUp: "حرّك لفوق",
      moveDown: "حرّك لتحت",
      allowTransition: "السماح بالانتقال من {from} إلى {to}",
    ...
    status: {
      ...
      pricingUnavailable: "التسعير غير متاح مؤقتًا. جرّب مرة ثانية 🔄",
      tryAgain: "جرّب مرّة ثانية",
    ...
    team: {
      title: "الفريق",
      subtitle: "تحكّم بمين إله صلاحية الدخول عالمؤسسة وشو يقدر يعمل",
      addMember: "زيد عضو",
      loadError: "ما قدرنا نحمّل الفريق. جرّب مرّة ثانية.",
      empty: "لسّا ما في أعضاء بالفريق",
      emptyDescription: "زيد أول عضو بالفريق لتشارك الوصول لهاي المؤسسة.",
      email: "الإيميل",
      name: "الاسم",
      password: "كلمة السر",
      passwordHint: "بس لازم إذا هالشخص ما عنده حساب أصلاً (٨ محارف عالأقل).",
      role: "الصلاحية",
      status: "الحالة",
      joined: "انضم",
      roleOwner: "مالك",
      ...
      addTitle: "زيد عضو بالفريق",
      addSubmit: "زيد العضو",
      addSuccess: "تمت إضافة العضو",
      addError: "ما قدرنا نزيد هالعضو. جرّب مرّة ثانية.",
      changeRole: "غيّر صلاحية {name}",
      changeStatus: "غيّر حالة {name}",
      updateError: "ما قدرنا نحدّث هالعضو. جرّب مرّة ثانية.",
