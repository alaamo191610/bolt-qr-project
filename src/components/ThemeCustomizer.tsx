                ...
                <div className="grid grid-cols-2 gap-3">
                  {classyPresets.map(p => (
                    <button
                      ...
                      className="group p-3 rounded-2xl border bg-white/60 dark:bg-slate-800/50 border-slate-200 dark:border-slate-700 hover:border-slate-300 dark:hover:border-slate-600 transition"
                    >
                      ...
                      <div className="text-left">
                        <p className="text-sm font-medium text-slate-900 dark:text-white group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition">
                          {p.name}
                        </p>
