...
//   // guard against duplicate setup in dev StrictMode
...
//       if (!uid) return;
//       if (langLoadedForRef.current === uid) return;
...
//           if (pref && localStorage.getItem("restaurant-language") !== pref) {
...
//         } catch (e) {
//           console.error("Error loading admin language preference:", e);
//         } finally {
